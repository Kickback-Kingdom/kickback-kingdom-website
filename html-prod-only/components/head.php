<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta name="description" content="Top secret super cool hangout spot">
    ...
    <link rel="stylesheet" type="text/css" href="../assets/css/kickback.css">


    <style>
li.sidebar-list > ul > li > a::after{
    display:none;
}
