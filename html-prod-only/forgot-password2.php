...
require("php-components/base-page-pull-active-account-info.php");
  ...
  {
      require("api/v1/engine/engine.php");

      //use PHPMailer\PHPMailer\PHPMailer;
      //use PHPMailer\PHPMailer\Exception;

      require("api/v1/engine/PHPMailer/Exception.php");
      require("api/v1/engine/PHPMailer/PHPMailer.php");
      require("api/v1/engine/PHPMailer/SMTP.php");
      $email = $_POST["email"];
                                              ...
                                              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:670px;background:#fff; border-radius:3px; text-align:center;-webkit-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);-moz-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);box-shadow:0 6px 18px 0 rgba(0,0,0,.06); margin-bottom: 100px;">
                                                  ...
                                                  <tr>
                                                      <td style="padding:0 35px;">
                                                          ...
                                                          <a href="https://kickback-kingdom.com/reset-password.php?c='.$code.'&i='.$account["Id"].'" style="background:#08B9ED;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">Reset
                                                                                          Password</a>
                                                      </td>
                                                  </tr>
                                                  <tr>
