...
if (isset($_POST["submit-quest-review"])) {
    ...
    $reviewResp = QuestController::SubmitFeedbackAndCollectRewards(Kickback\Services\Session::getCurrentAccount(),$quest_id,$hostRating,$questRating,$comment);
...
if (isset($_POST["submit-notifications-thanks-for-hosting"]))
{
    ...
    $reviewResp = QuestController::SubmitFeedbackAndCollectRewards(Kickback\Services\Session::getCurrentAccount(),$quest_id,null,null,null);
