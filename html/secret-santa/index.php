    ...
    <main class="container pt-3 bg-body" style="margin-bottom: 56px;">
        <div class="row">
            <div class="col-12 col-xl-9">
                ...
                <section class="position-relative overflow-hidden rounded-4 mb-4" style="background: radial-gradient(circle at 20% 20%, rgba(255, 99, 132, 0.25), transparent 35%), radial-gradient(circle at 80% 10%, rgba(13, 110, 253, 0.25), transparent 30%), linear-gradient(135deg, #0d6efd 0%, #842029 100%);">
                    <div class="row g-0 align-items-center text-light p-4 p-md-5">
                        <div class="col-md-7">
                            <p class="text-uppercase fw-semibold small mb-1">Holiday event toolkit</p>
                            <h1 class="display-5 fw-bold mb-3">Kickback Kingdom Secret Santa</h1>
                            <p class="lead mb-4">Plan the exchange, collect signups, manage exclusions, and reveal matches without leaving the Kingdom. Owners and participants each get a clear path.</p>
                        ...
                        <div class="col-md-5 text-center text-md-end mt-4 mt-md-0">
                            <div class="card bg-white bg-opacity-75 border-0 shadow-lg d-inline-block text-start" style="min-width: 280px;">
                                <div class="card-body">
                ...
                <section id="how-it-works" class="mb-5">
                    ...
                    <p class="text-secondary">Everything you need to launch, manage, or participate in a gift exchange. Choose the card that matches your role.</p>
