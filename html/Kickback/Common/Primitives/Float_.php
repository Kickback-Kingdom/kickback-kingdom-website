...
/**
* Extended functionality for the `float` type.
*/
final class Float_
{
    ...
    * @param-out  float         $min_value
    *
    * @return (
    *   $arr is non-empty-array<array-key, null>   ? false :
    *   $arr is non-empty-array<array-key, ?float> ? true  : false)
    */
    ...
    */
    public static function first_min_pair(array $arr, int|string|null &$min_key,  float &$min_value) : int
    {
    ...
    * @return int  The 0-based position in the array where the minimum occurs.
    */
    public static function last_min_pair(array $arr, int|string|null &$min_key,  float &$min_value) : int
    {
    ...
    * @return int  The 0-based position in the array where the minimum occurs.
    */
    public static function first_max_pair(array $arr, int|string|null &$max_key,  float &$max_value) : int
    {
    ...
    * @return int  The 0-based position in the array where the minimum occurs.
    */
    public static function last_max_pair(array $arr, int|string|null &$max_key,  float &$max_value) : int
    {
